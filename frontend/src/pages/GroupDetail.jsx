        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mt-5 flex lg:mt-0 lg:ml-4 space-x-3 items-center">
            ...
            <button
              ...
              className={`inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium ${isUploading ? 'text-gray-400 bg-gray-100 cursor-not-allowed' : 'text-gray-700 bg-white hover:bg-gray-50'} focus:outline-none`}
            >
              {isUploading ? (
                <>
